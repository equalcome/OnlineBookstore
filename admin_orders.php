...
if(isset($_POST['update_order'])){
   ...
   echo '<script>alert("付款狀態已更新!")</script>';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> 使用者id : <span><?php echo $fetch_orders['user_id']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <input type="submit" value="更新" name="update_order" class="option-btn">
            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id']; ?>" onclick="return confirm('刪除訂單?');" class="delete-btn">刪除</a>
         </form>
      </div>
      <?php
         }
