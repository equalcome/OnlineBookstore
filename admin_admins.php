...
<section class="users">
   ...
   <h1 class="title"> 管理者帳號總覽 </h1>
    <div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
        <a href="register_admin.php" class="btn btn-primary">新增管理者</a>
    </div>
      

   <div class="box-container">
      <?php
      $select_users = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'admin' AND id <> '$admin_id'") or die('query failed');
      while ($fetch_users = mysqli_fetch_assoc($select_users)) {
         ...
         <div class="box">
            ...
            ?>
            <a href="admin_admins.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">刪除該使用者</a>
